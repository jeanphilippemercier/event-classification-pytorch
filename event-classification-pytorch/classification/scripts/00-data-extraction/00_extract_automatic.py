...
result, res = sc.events_list(evaluation_mode='automatic',
                             status='rejected',
                             page_size=100)
...
for i, re in enumerate(res):
    re_gcp = RequestEventGCP(re, 'ot-automatic-rejected',
                             'event-classification-mel-spectrograms')
    re_gcp.write_data_to_bucket()
